...
| T27 | Write final paper (8 pages) | Bhalchandra | DONE (draft) | Full final paper `paper/main.md` -> `paper/main.docx` (~4.1k words, ~8 pages): abstract, intro, related work, EDA, method, results (RQ1 + top-k + RQ3), error analysis (RQ2 taxonomy + Fig 2 + Table 4), conclusion/limitations. Citations resolved, figures embedded. Pending final proofread (T28). | 2026-07-24 |  |
