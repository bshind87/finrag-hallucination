...
| T11 | Expand related work (20–24 papers) | Bhalchandra + team | DONE | 24 real papers synthesized (not listed) across 3 themes in the paper's Related Work; `paper/references.bib`. | 2026-07-03 | 2026-07-24 |
...
| T13 | Write & submit prelim paper | team | DONE | Preliminary paper submitted 2026-07-03 (`paper/CS6120NLP_RAG_Hallucination_preliminary_paper.pdf`); frozen as `paper/preliminary_paper.docx`. | 2026-07-03 | 2026-07-03 |
...
| T29 | Design poster | Bhalchandra, Rituraj | DONE | Final poster `paper/CS6120NLP_Group7_FinRAG_poster.jpeg` — 6-panel infographic (dataset, method, RQ1/RQ2/RQ3, detection); all numbers verified. | 2026-07-29 | 2026-07-31 |
| T30 | Build presentation slides | Bhalchandra, Rituraj | DONE | Final 13-slide deck `paper/CS6120NLP_Group7_FinRAG_presentation.pdf` (numbers verified) + slide-by-slide `paper/CS6120NLP_Group7_FinRAG_presenter_notes.md` (4 blocks, ~2 min each). | 2026-07-29 | 2026-07-31 |
| T31 | Record video (≤8 min) | team | IN PROGRESS | Presenter notes + 4-block split ready (~7:45; ~2 min/member). Pending: team picks blocks, then record + enforce the hard 8-min cutoff. | 2026-07-31 |  |
...
- **Status:** DONE  · **Owner:** Bhalchandra  · **Est:** 4 days (parallel)
...
- **Status:** IN PROGRESS  · **Owner:** team  · **Est:** 1 day
...
- **Status:** DONE  · **Owner:** Bhalchandra, Rituraj  · **Est:** 1.5 days
...
- **Status:** DONE  · **Owner:** Bhalchandra, Rituraj  · **Est:** 1 day
